...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TransactionCategory.account'
        db.add_column(u'accounting_transactioncategory', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounting.Account']),
                      keep_default=False)

        # Adding field 'TransactionMethod.account'
        db.add_column(u'accounting_transactionmethod', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounting.Account']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TransactionCategory.account'
        db.delete_column(u'accounting_transactioncategory', 'account_id')

        # Deleting field 'TransactionMethod.account'
        db.delete_column(u'accounting_transactionmethod', 'account_id')
