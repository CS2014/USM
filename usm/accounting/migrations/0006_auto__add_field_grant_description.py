...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Grant.description'
        db.add_column(u'accounting_grant', 'description',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Grant.description'
        db.delete_column(u'accounting_grant', 'description')
