...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Log.modified_date'
        db.delete_column(u'accounting_log', 'modified_date')

        # Adding field 'Log.user'
        db.add_column(u'accounting_log', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Log.modified_date'
        db.add_column(u'accounting_log', 'modified_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 13, 0, 0)),
                      keep_default=False)

        # Deleting field 'Log.user'
        db.delete_column(u'accounting_log', 'user_id')
